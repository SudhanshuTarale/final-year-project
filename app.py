...
def create_connection(db_file):
    ...
    conn = None
    try:
        conn = sql.connect(db_file, isolation_level=None, detect_types=sql.PARSE_COLNAMES)
    except Error as e:
        print(e)
...
def output():
    ...
    if request.method == 'POST':
        ...
        cur = conn.cursor()
        read_transactions = pd.read_csv (r'/Users/sudhanshutarale/Desktop/fyp_update/TwoWayTransactions.csv')
        ...
        read_transactions.to_sql('TwoWayTransactions', conn, if_exists='replace', index = False)
        ...
        with sql.connect("/Users/sudhanshutarale/Transaction.db") as conn:
            ...
            burst_in_originator_rule(conn,minout3,minben3,tsout3,minin3,mincre3,tsin3,sd1,ed1)
        ...
        path = "///Users/sudhanshutarale/Desktop/fyp_update/scoring/" + date_time+".csv"
        df = pd.read_csv(path)
        df.index = df.index+1
...
def threshold_amount_rule(conn,sd1,ed1,tsum1,tsin1):
    ...
    cur.execute("CREATE TABLE sum_rule1 ( `out_acc_num` INTEGER, `sum_transactionamount` INTEGER)")
    ...
    db_df.to_csv(
        '/Users/sudhanshutarale/Desktop/fyp_update/csv/test/Rule1atest.csv', index=False)
    ...
    db_df.to_csv(
        '/Users/sudhanshutarale/Desktop/fyp_update/Rule1btest.csv', index=False)

    # MLrule1a
    df = pd.read_csv(
        "/Users/sudhanshutarale/Desktop/fyp_update/csv/train/Rule1atrain.csv")
    ...
    model.fit(X, y)
    df1 = pd.read_csv(
        "/Users/sudhanshutarale/Desktop/fyp_update/csv/test/Rule1atest.csv")
    x = ['sum_transactionamount', 'net_worth', 'credit_score', 'ratio_cash_deposits', 'ratio_cash_withdrawals',
         'ratio_incoming_international', 'ratio_outgoing_international']
    x_test = df1[x]
    predicted = model.predict(x_test)
    submission = pd.read_csv("/Users/sudhanshutarale/Desktop/fyp_update/sample.csv")
    ...
    pd.DataFrame(submission, columns=['out_acc_num', 'label']).to_csv(
        '/Users/sudhanshutarale/Desktop/fyp_update/output/OutputRule1a.csv')

    # MLrule1b
    df = pd.read_csv(
        "/Users/sudhanshutarale/Desktop/fyp_update/csv/train/Rule1btrain.csv")
    model = tree.DecisionTreeClassifier(criterion='gini')
    ...
    model.fit(X, y)
    df1 = pd.read_csv(
        "/Users/sudhanshutarale/Desktop/fyp_update/csv/test/Rule1btest.csv")
    ...
    submission['label'].replace(1, 'Yes', inplace=True)
    pd.DataFrame(submission, columns=['out_acc_num', 'label']).to_csv(
        '/Users/sudhanshutarale/Desktop/fyp_update/output/OutputRule1b.csv')
...
def excessive_funds_rule(conn,minsum2,sd1,ed1):
    ...
    cur.execute("CREATE VIEW risky_all as select * from risky_sum_out union select * from risky_sum_in")
    cur.execute("DROP TABLE IF EXISTS sumofrisky")
    cur.execute("CREATE TABLE sumofrisky ( `out_acc_num` INTEGER, `totalriskyamount` INTEGER)")
    ...
    cur.execute("CREATE TABLE rule2 ( `out_acc_num` INTEGER, `totalriskyamount` INTEGER)")
    cur.execute("INSERT INTO rule2 SELECT * FROM sumofrisky WHERE sumofrisky.totalriskyamount > ?", (minsum2,))
    ...
    db_df.to_csv(
        '/Users/sudhanshutarale/Desktop/fyp_update/Rule2test.csv', index=False)

    # MLrule2
    df = pd.read_csv(
        "/Users/sudhanshutarale/Desktop/fyp_update/csv/train/Rule2train.csv")
    model = tree.DecisionTreeClassifier(criterion='gini')
    ...
    model.fit(X, y)
    df1 = pd.read_csv(
        "/Users/sudhanshutarale/Desktop/fyp_update/csv/test/Rule2test.csv")
    ...
    submission['label'].replace(1, 'Yes', inplace=True)
    pd.DataFrame(submission, columns=['out_acc_num', 'label']).to_csv(
        '/Users/sudhanshutarale/Desktop/fyp_update/output/OutputRule2.csv')
...
def burst_in_originator_rule(conn,minout3,minben3,tsout3,minin3,mincre3,tsin3,sd1,ed1):
    ...
    cur.execute("CREATE TABLE outburst ( out_acc_num INTEGER, no_of_out INTEGER,sumout INTEGER, distinct_no_of_out INTEGER) ")
    ...
    cur.execute("CREATE TABLE rule3a ( out_acc_num INTEGER, no_of_out INTEGER,sumout INTEGER, distinct_no_of_out INTEGER )")
    cur.execute("INSERT INTO rule3a SELECT * FROM outburst WHERE outburst.no_of_out > ? AND outburst.sumout > ? AND outburst.distinct_no_of_out > ?",(minout3,minben3,tsout3,))
    ...
    db_df.to_csv('/Users/sudhanshutarale/Desktop/fyp_update/Rule3atest.csv', index=False)
    ...
    cur.execute("CREATE TABLE inburst ( out_acc_num INTEGER, no_of_in INTEGER,sumin INTEGER, distinct_no_of_in INTEGER) ")
    ...
    cur.execute("CREATE TABLE rule3b ( out_acc_num INTEGER, no_of_in INTEGER,sumin INTEGER, distinct_no_of_in INTEGER )")
    cur.execute("INSERT INTO rule3b SELECT * FROM inburst WHERE inburst.no_of_in > ? AND inburst.sumin > ? AND inburst.distinct_no_of_in > ?",(minin3,mincre3,tsin3,))
    ...
    db_df.to_csv('/Users/sudhanshutarale/Desktop/fyp_update/Rule3btest.csv', index=False)

    # MLrule3a
    df = pd.read_csv(
        "/Users/sudhanshutarale/Desktop/fyp_update/csv/train/Rule3atrain.csv")
    model = tree.DecisionTreeClassifier(criterion='gini')
    ...
    model.fit(X, y)
    df1 = pd.read_csv(
        "/Users/sudhanshutarale/Desktop/fyp_update/csv/test/Rule3atest.csv")
    ...
    submission['label'].replace(1, 'Yes', inplace=True)
    pd.DataFrame(submission, columns=['out_acc_num', 'label']).to_csv(
        '/Users/sudhanshutarale/Desktop/fyp_update/output/OutputRule3a.csv')

    # MLrule3b
    df = pd.read_csv(
        "/Users/sudhanshutarale/Desktop/fyp_update/csv/train/Rule3btrain.csv")
    model = tree.DecisionTreeClassifier(criterion='gini')
    ...
    model.fit(X, y)
    df1 = pd.read_csv(
        "/Users/sudhanshutarale/Desktop/fyp_update/csv/test/Rule3btest.csv")
    ...
    submission['label'].replace(1, 'Yes', inplace=True)
    pd.DataFrame(submission, columns=['out_acc_num', 'label']).to_csv(
        '/Users/sudhanshutarale/Desktop/fyp_update/output/OutputRule3b.csv')
...
def structuring_activity_rule(conn,lout4,uout4,lin4,uin4,sd1,ed1):
    ...
    db_df.to_csv('/Users/sudhanshutarale/Desktop/fyp_update/Rule4atest.csv', index=False)
    ...
    db_df.to_csv(
        '/Users/sudhanshutarale/Desktop/fyp_update/Rule4btest.csv', index=False)

    # MLrule4a
    df = pd.read_csv(
        "/Users/sudhanshutarale/Desktop/fyp_update/csv/train/Rule4btrain.csv")
    model = tree.DecisionTreeClassifier(criterion='gini')
    ...
    model.fit(X, y)
    df1 = pd.read_csv(
        "/Users/sudhanshutarale/Desktop/fyp_update/csv/test/Rule4btest.csv")
    ...
    submission['label'].replace(1, 'Yes', inplace=True)
    pd.DataFrame(submission, columns=['out_acc_num', 'label']).to_csv(
        '/Users/sudhanshutarale/Desktop/fyp_update/output/OutputRule4a.csv')
    ...
    submission['label'].replace(1, 'Yes', inplace=True)
    pd.DataFrame(submission, columns=['out_acc_num', 'label']).to_csv(
        '/Users/sudhanshutarale/Desktop/fyp_update/output/OutputRule4b.csv')
...
def create_view_date_interval(conn,sd1,ed1):
    ...
    cur.execute("INSERT INTO rows_enddate SELECT * FROM TwoWayTransactions WHERE `out_date_key`< ?", (ed1,))
...
def score():
    df1a = pd.read_csv("/Users/sudhanshutarale/Desktop/fyp_update/output/OutputRule1a.csv")
    df1a.rename({"Unnamed: 0":"a"}, axis="columns", inplace=True)
    df1a.drop(["a"], axis=1, inplace=True)
    rslt_df1a = df1a[df1a['label'] == 'Yes']

    df2 = pd.read_csv("/Users/sudhanshutarale/Desktop/fyp_update/output/OutputRule2.csv")
    ...
    df3a = pd.read_csv("/Users/sudhanshutarale/Desktop/fyp_update/output/OutputRule3a.csv")
    ...
    df3b = pd.read_csv("/Users/sudhanshutarale/Desktop/fyp_update/output/OutputRule3b.csv")
    ...
    pd.DataFrame(rslt_df1a, columns=['out_acc_num','label']).to_csv('/Users/sudhanshutarale/Desktop/fyp_update/scoring/Outscore.csv')

    df1b = pd.read_csv("/Users/sudhanshutarale/Desktop/fyp_update/output/OutputRule1b.csv")
    df1b.rename({"Unnamed: 0":"a"}, axis="columns", inplace=True)
    df1b.drop(["a"], axis=1, inplace=True)
    rslt_df1b = df1b[df1b['label'] == 'Yes']

    df4a = pd.read_csv("/Users/sudhanshutarale/Desktop/fyp_update/output/OutputRule4a.csv")
    ...
    df4b = pd.read_csv("/Users/sudhanshutarale/Desktop/fyp_update/output/OutputRule4b.csv")
    ...
    pd.DataFrame(rslt_df1b, columns=['out_acc_num','label']).to_csv('/Users/sudhanshutarale/Desktop/fyp_update/scoring/Outscore2.csv')

def suspicious_accounts(conn):
        
    cur = conn.cursor()    
    read_suspicious_accounts = pd.read_csv (r'/Users/sudhanshutarale/Desktop/fyp_update/scoring/Outscore.csv')
    read_suspicious_accounts.rename({"Unnamed: 0":"a"}, axis="columns", inplace=True)
    read_suspicious_accounts.drop(["a"], axis=1, inplace=True)
    cur.execute("DROP TABLE IF EXISTS Outscore")
    cur.execute("CREATE TABLE Outscore ( `out_acc_num` INTEGER, `suspicious_score` INTEGER )")
    read_suspicious_accounts.to_sql('Outscore', conn, if_exists='replace', index = False)
    df1a = pd.read_csv("/Users/sudhanshutarale/Desktop/fyp_update/output/OutputRule1a.csv")
    cur.execute("DROP TABLE IF EXISTS CountA")
    cur.execute("CREATE TABLE CountA ( `out_acc_num` INTEGER, `suspicious_score` INTEGER )")
...
def suspicious_transactions(conn):
    ...
    cur = conn.cursor()
    read_suspicious_transactions = pd.read_csv (r'/Users/sudhanshutarale/Desktop/fyp_update/scoring/Outscore2.csv')
    read_suspicious_transactions.rename({"Unnamed: 0":"a"}, axis="columns", inplace=True)
    read_suspicious_transactions.drop(["a"], axis=1, inplace=True)
    cur.execute("DROP TABLE IF EXISTS Outscore2")
    cur.execute("CREATE TABLE Outscore2 ( `out_acc_num` INTEGER, `no_of_suspicious_transactions` INTEGER )")
    read_suspicious_transactions.to_sql('Outscore2', conn, if_exists='replace', index = False)
    cur.execute("DROP TABLE IF EXISTS CountB")
    cur.execute("CREATE TABLE CountB ( `out_acc_num` INTEGER, `no_of_suspicious_transactions` INTEGER )")
...
def final_score(conn,min_threshold):
    ...
    cur.execute("UPDATE FinalScore SET no_of_suspicious_transactions = '0' WHERE no_of_suspicious_transactions IS null")
    cur.execute("UPDATE FinalScore SET suspicious_score = '0' WHERE suspicious_score IS null")
    db_df = pd.read_sql_query("SELECT * FROM FinalScore", conn)
    db_df.to_csv('/Users/sudhanshutarale/Desktop/fyp_update/scoring/FinalScore.csv', index=False)
    db_df['red_flags'] = db_df['suspicious_score'] + db_df['no_of_suspicious_transactions'] 
    pd.DataFrame(db_df, columns=['out_acc_num','suspicious_score','no_of_suspicious_transactions', 'red_flags']).to_csv('/Users/sudhanshutarale/Desktop/fyp_update/scoring/FinalScore.csv')
    avg = db_df['no_of_suspicious_transactions'].mean(axis = 0)
    print("****************************Aveage no of suspicious transactions: ", avg )
    avg = round(avg, 0)
    db_df2 = db_df[(db_df['suspicious_score'] >= min_threshold) & (db_df['no_of_suspicious_transactions'] >= avg)]
    db_df2 = db_df2.rename(columns={'out_acc_num': 'Account Number', 'suspicious_score': 'Risk Score', 'no_of_suspicious_transactions': 'No. of Suspicious Transactions', 'red_flags': 'No. of Red Flags'})
    filename = datetime.now()
    date_time = str(filename.strftime("%d-%m-%Y_%H:%M:%S"))
    # print("-------------------------------------------------------The file name is", date_time)
    path = "///Users/sudhanshutarale/Desktop/fyp_update/scoring/" + date_time+".csv"
    pd.DataFrame(db_df2, columns=['Account Number', 'Risk Score', 'No. of Suspicious Transactions', 'No. of Red Flags']).to_csv(path)
    # pd.DataFrame(db_df2, columns=['out_acc_num','suspicious_score','no_of_suspicious_transactions', 'red_flags']).to_csv('/Users/sudhanshutarale/Desktop/fyp_update/scoring/FinalScoreTh.csv')
